...
$certificate_path = "certs/Certificates.p12"; // Change this to the path where your certificate is located
$certificate_password = "MacMac115"; // Change this to the certificate's import password
...
function create_signature($package_dir, $cert_path, $cert_password) {
    ...
    openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, 
    $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "/push/certs/AppleWWDRCAG3.pem");
